...
export const metadata: Metadata = {
  ...
  description:
    "Visualisez vos espaces meublés par l'IA en quelques secondes. 11 styles de décoration, téléchargement HD gratuit. Pour architectes, marchands de biens et particuliers.",
