...
export const metadata: Metadata = {
  ...
  description: "Mentions légales de Versimo — éditeur, hébergeur, propriété intellectuelle.",
        ...
        <div className="space-y-8 text-sm text-muted font-light leading-relaxed">
          <section>
            ...
            <div className="mt-3 space-y-1">
              <p><strong className="text-foreground font-medium">Versimo</strong></p>
              <p>Forme juridique : [À compléter]</p>
              <p>SIRET : [À compléter]</p>
              <p>Adresse du siège social : [À compléter]</p>
              <p>Email : <a href="mailto:contact@versimo.fr" className="text-sage hover:underline">contact@versimo.fr</a></p>
            </div>
          </section>
          ...
          <section>
            ...
            <p>
              L&apos;ensemble des éléments du site Versimo — textes, interface, code source, logo — est la propriété exclusive de Versimo, sauf mention contraire.
            </p>
            <p className="mt-3">
              Les visuels générés par le service sont produits par intelligence artificielle. L&apos;utilisateur conserve tous les droits sur les photos qu&apos;il uploade. Versimo accorde une licence d&apos;utilisation large sur les images générées, y compris à des fins commerciales.
            </p>
          ...
          <section>
            ...
            <p>
              Versimo utilise les technologies suivantes : Next.js (interface), OpenAI gpt-4.1 (génération d&apos;images IA), Flux Depth Pro via Replicate (modèle de secours), PostgreSQL (base de données).
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Pour toute question : <a href="mailto:contact@versimo.fr" className="text-sage hover:underline">contact@versimo.fr</a>
            </p>
          </section>
        </div>
