      ...
      <main className="max-w-4xl mx-auto px-5 sm:px-8 py-8 sm:py-12">
        ...
        {isLoading ? (
          ...
          <div className="space-y-8">
            {/* ── Merchant toggle ── */}
            <div className="border border-foreground/5 rounded-2xl p-5" data-testid="merchant-profile-section">
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  type="checkbox"
                  checked={isMerchant}
                  onChange={(e) => setIsMerchant(e.target.checked)}
                  className="w-5 h-5 rounded border-foreground/5 text-sage focus-visible:ring-sage/50 focus-visible:ring-offset-2"
              ...
              <div className="space-y-6 animate-fade-in-up">
                ...
                <div className="border border-foreground/5 rounded-2xl p-5 space-y-4">
                  ...
                  <div ref={searchRef} className="relative">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3 pr-10 border border-foreground/10 rounded-xl text-sm font-normal focus-visible:border-foreground focus:outline-none transition-colors placeholder:text-foreground/30"
                    ...
                    {showResults && companyResults.length > 0 && (
                      <div className="absolute z-50 left-0 right-0 mt-2 bg-background border border-foreground/5 rounded-xl shadow-lg overflow-hidden">
                        {companyResults.map((company, i) => (
                          <button
                            key={`${company.siret}-${i}`}
                            onClick={() => selectCompany(company)}
                            className="w-full text-left px-4 py-3 hover:bg-foreground/[0.03] transition-colors border-b border-foreground/5 last:border-b-0"
                          >
                            <p className="text-sm font-medium text-foreground">{company.raisonSociale}</p>
                            <p className="text-xs text-muted font-light mt-0.5">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs text-muted/60 font-light">ou par SIRET</span>
                    <div className="flex-1 h-px bg-foreground/5" />
                  </div>
                  ...
                  <div className="flex gap-2">
                    <div className="flex-1">
                      ...
                      <input
                        ...
                        inputMode="numeric"
                        maxLength={17}
                        className="w-full px-4 py-3 border border-foreground/10 rounded-xl text-sm font-normal focus-visible:border-foreground focus-visible:ring-2 focus-visible:ring-sage/50 focus:outline-none transition-colors placeholder:text-foreground/30"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 border border-foreground/10 rounded-xl text-sm font-normal focus-visible:border-foreground focus:outline-none transition-colors placeholder:text-foreground/30"
                ...
                <div className="border border-foreground/5 rounded-2xl p-5 space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4">
                      {logoPreview ? (
                        <div className="w-16 h-16 rounded-xl border border-foreground/5 overflow-hidden shrink-0">
                        ...
                        <div className="w-16 h-16 rounded-xl border border-dashed border-foreground/5 flex items-center justify-center shrink-0">
                      ...
                      <div>
                        <button
                          ...
                          className="text-sm font-medium text-sage hover:text-sage/80 transition-colors disabled:opacity-40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sage/50 focus-visible:ring-offset-2 rounded"
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 border border-foreground/10 rounded-xl text-sm font-normal focus-visible:border-foreground focus:outline-none transition-colors bg-transparent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sage/50"
                  ...
                  {/* Preview swatch */}
                  <div className="p-4 rounded-xl border border-foreground/5">
                    <p className="text-xs text-muted font-light mb-2">Aperçu</p>
                    <div className="flex items-center gap-3">
                      <div
                ...
                <div className="flex items-center gap-4">
                  <button
                    onClick={handleSave}
                    disabled={isSaving}
                    className="px-8 py-3 bg-foreground text-background rounded-full font-medium text-sm hover:bg-foreground/85 transition-colors disabled:opacity-40 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sage/50 focus-visible:ring-offset-2"
                  ...
                  {saveMessage && (
                    <span
                      className={`text-sm font-normal animate-fade-in-up ${
                        saveMessage.type === "success" ? "text-sage" : "text-red-500"
                      }`}
                    >
                      {saveMessage.text}
                    </span>
