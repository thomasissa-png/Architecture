...
4. Pour chaque génération retenue, lire **2 images max** avec Read :
   ...
   - **NE PAS charger pass1** sauf si l'output montre un problème de surfaces (murs, sol, plafond)
5. Si une image ne charge pas → noter "image indisponible" et continuer. Ne pas retenter.
6. Analyser visuellement : comparer input vs output (géométrie, fenêtres, angle, murs, luminaires)

### Phase 3 — RAPPORT
7. Noter chaque génération sur la grille 10 critères
8. Identifier les patterns récurrents
9. Produire un plan d'amélioration P0-P4 avec corrections concrètes → Edit le rapport
