      ...
      {menuOpen && (
        <div className="absolute right-0 top-full mt-2 w-56 bg-background border border-foreground/10 rounded-2xl shadow-lg py-2 z-50 animate-fade-in-up">
          ...
          <div className="px-2 py-1 border-b border-foreground/5">
            ...
            <a
              href="/support"
              className="flex items-center gap-2 px-3 py-2 text-sm text-muted font-light hover:text-foreground hover:bg-foreground/5 rounded-xl transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sage/50"
              onClick={() => setMenuOpen(false)}
            >
