    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-wrap items-center justify-center gap-2">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 bg-foreground text-background px-5 py-2.5 rounded-full text-sm font-medium hover:bg-foreground/85 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sage/50 focus-visible:ring-offset-2"
        >
        ...
        <button
          ...
          className="inline-flex items-center gap-2 border border-gray-300 text-muted px-4 py-2.5 rounded-full text-sm font-medium hover:bg-gray-50 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sage/50 focus-visible:ring-offset-2"
        >
          {copied ? (
            <>
