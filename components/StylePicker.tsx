...
export const STYLES: StyleOption[] = [
  {
    ...
    furniturePrompt:
      "A serene Nordic living space. FOREGROUND: large straight three-seat sofa in oatmeal boucle with low squared arms and birch legs 230cm wide facing center, light birch rectangular coffee table with slim tapered legs 120cm in front of sofa, cream wool loop-pile area rug 200x300cm under the grouping. LATERAL: light ash lounge chair with woven paper cord seat and curved back (Wegner-style) angled toward sofa. BACKGROUND: small round birch side table with stacked design books and white ceramic ribbed vases, potted trailing pothos in light grey stoneware planter, dried birch branches in a tall cylindrical stoneware vase. ACCENTS: slim matte black asymmetric floor lamp with angled cone shade (AJ-style) beside the chair, sheepskin throw draped over one sofa arm, taper candles on the coffee table, two woven wool cushions in muted blue and warm grey",
  },
  {
    id: "contemporary",
    name: "Contemporain",
