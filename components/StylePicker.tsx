...
export const STYLES: StyleOption[] = [
  ...
  },
  {
    ...
    surfacePrompt:
      "Maximalist eclectic: rich deep teal accent on the largest visible surface with remaining areas in off-white keeping the same overall brightness as the input photo, polished dark wood flooring, white ceiling finish applied strictly over the existing ceiling, matching its exact shape without adding any relief, beams, or coffers, dramatic sculptural pendant light in brass with colored glass elements",
    furniturePrompt:
