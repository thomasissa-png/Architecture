# Audit de conformité site — Versimo
...
|---------------------|-----------|----------|----------------------|
| **Mentions légales** (LCEN Art. 6 III) | NON | **P0** | Footer : uniquement "© Versimo 2026" + lien mailto — pas de page dédiée |
...
| **Email de contact** accessible | OUI | — | mailto:contact@versimo.fr dans footer et pricing Business |
...
| Ajouter watermark discret ou métadonnées EXIF "Généré par IA — Versimo" sur images téléchargées | @fullstack |
| Ajouter durée de validité des crédits et politique de remboursement dans la section pricing | @fullstack + @copywriter |
| Créer email privacy@versimo.fr et le mentionner dans la politique de confidentialité | Fondateur |
...
- Documents à rédiger (chemin obligatoire : `docs/legal/`) :
  ...
  - `privacy-policy.md` : politique de confidentialité RGPD — données collectées (photos, IP, logs), bases légales, transfert OpenAI (DPF), rétention 30j/90j, droits utilisateurs, contact privacy@versimo.fr
