...
**Critères d'acceptation** :
- [ ] CA-1 : Le PDF contient : page de garde (adresse, photo principale meublée, logo Versimo), description du bien, visuels meublés (1 par page, format A4 paysage), mentions légales minimales.
