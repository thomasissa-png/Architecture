...
<a
  ...
  download={`${photo.roomLabel || "visuel"}-apres-versimo.jpg`}
...
- Points d'attention :
  ...
  - Le bond Retrouvabilité (3 → 8, +5 pts) est la correction V3 la plus structurellement importante — elle transforme Versimo d'un outil one-shot en outil de travail récurrent pour Thomas
