...
| 7 | Partage conjoint(e) | 6/10 | 7/10 | +1 | Page web : OpenGraph metadata title+description dynamiques, ShareButtons. PDF : nom de fichier clean `T3-Chartrons-versiroom.pdf`. La page web est nettement superieure pour le partage couple |
