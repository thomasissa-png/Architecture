...
| 6 | Contact vendeur (1 tap) | 9/10 | 9.5/10 | +0.5 | Fallback mailto contact@versiroom.fr si profil vide — plus de composant null, CTA toujours present |
...
| 9 | Confiance / credibilite | 9/10 | 9/10 | = | Disclaimer visible maintenu. Section contact bas de page encore conditionnelle (Thomas absent = Versiroom) |
