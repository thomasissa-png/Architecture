...
**Resolution proposee** : Ajouter un verrou simple (flag `reinitializing`) pour eviter la double-creation. Alternative acceptable : documenter le risque et ne pas corriger (impact negligeable pour le volume de trafic actuel de VisiRenov en alpha).
