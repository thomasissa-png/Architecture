...
| 2026-03-27 | La préservation de la pièce d'origine (taille, angle, géométrie) est le critère n°1 absolu | A insisté : "le respect de la pièce d'origine en taille, en angle etc. doit être le critère numéro 1" | Grille pondérée : géométrie ×3, éléments structurels ×3 (poids max). G1/G2 BLOQUANTS, score <7 = NO-GO. |
| 2026-03-27 | Zéro donnée inventée — tout doit être mesuré sur des exemples réels | A demandé "assure-toi que ce soit des exemples réels et pas du vent" | Toujours tester sur des images réelles de production. Jamais d'audit "à sec" sans images. Données mesurées = seule source de vérité. |
| 2026-03-27 | Mode Marchand renommé Mode Pro, prix 29€/mois abonnement | Décision fondateur : abonnement mensuel avec crédits inclus au lieu de packages one-shot pour le tier Pro | Pricing: Pro 29€/mois (50 crédits, dossiers pré-commercialisation, liens sans limite). Seuil rentabilité 110 abonnés. |
