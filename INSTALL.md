...
```bash
curl -fsSL https://raw.githubusercontent.com/thomasissa-png/Agent-Team/claude/extract-project-context-BrqhN/update.sh -o update.sh && chmod +x update.sh
```
...
>
> 1. `git clone https://github.com/thomasissa-png/Agent-Team -b claude/extract-project-context-BrqhN /tmp/Agent-Team 2>/dev/null || (cd /tmp/Agent-Team && git pull origin claude/extract-project-context-BrqhN)`
...
git clone https://github.com/thomasissa-png/Agent-Team -b claude/extract-project-context-BrqhN /tmp/Agent-Team 2>/dev/null || \
