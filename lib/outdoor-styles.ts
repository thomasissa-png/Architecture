...
export const OUTDOOR_STYLES: Record<string, OutdoorStyle> = {
  ...
  mediterraneen_outdoor: {
    ...
    furniturePrompt:
      "A sun-warmed courtyard where wrought iron and terracotta age together under olive branches. Mediterranean outdoor furniture: round wrought-iron table 120cm in aged antique white finish with 4 matching bistro armchairs with woven rush seats, two glazed terracotta planters 90cm diameter with standard-trained olive trees 150cm overall height, three smaller terracotta pots 25-30cm with rosemary and lavender along the wall base, ceramic lanterns 25cm tall on table surface with unlit pillar candles, outdoor-rated woven polypropylene table runner 40x120cm in natural ecru with fringe edge. Warm convivial atmosphere.",
  },
  ...
  boheme_garden: {
    ...
    furniturePrompt:
      "A free-spirited garden corner where mismatched textures and trailing greenery blur the line between wild and curated. Bohemian garden furniture: two round weatherproof floor cushions 55cm in terracotta and mustard outdoor polyester fabric, low reclaimed-wood pallet coffee table 90x60cm aged grey finish, outdoor flat-weave polypropylene rug 160x230cm in warm earthy tones, freestanding bamboo rack 180cm with three hanging macrame plant holders, potted Heuchera 'Palace Purple' 40cm tall in woven sea-grass basket, potted Dryopteris filix-mas (male fern) and Rudbeckia mix in terracotta pots 30cm, battery string lights 2200K warm white draped loosely on the bamboo rack (unlit daytime). Layered informal atmosphere.",
  },
