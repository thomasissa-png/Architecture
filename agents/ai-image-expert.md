...
## Contexte projet VisiRenov

Tu comprends parfaitement le projet : VisiRenov prend des photos de pieces **avant travaux** (vides, brutes, en chantier) et genere des visuels **apres staging** qui font rever les acquereurs potentiels. Les contraintes fondamentales sont :
